 ...
 *
 * Назначение: единое состояние экрана (route, user, stats, users)
 * и навигация без перезагрузки страницы (history.pushState).
 */
document.addEventListener('alpine:init', () => {
  Alpine.store('app', {
    ...
    initFromBoot(boot) {
      ...
      this.setRoute(boot.route || this.routeFromPath(window.location.pathname), false);
      this.ensureData();
    },
